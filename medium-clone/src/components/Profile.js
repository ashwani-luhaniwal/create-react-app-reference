          ...
          <div className="hero-wrapper">
            <header className="hero">
              <div className="profile-info">
                ...
                <div className="hero-location"><i className="fa fa-map-marker"></i>{items.profile.user.provider}</div>
              </div>
            ...
            <div>
              <div data-react-className="UserFollowContainer" data-react-props="{&quot;followerCount&quot;:6,&quot;followingCount&quot;:2,&qout;following&qout;:false,&qout;followed_id&qout;:396,&qout;hideButton&qout;:false,&qout;username&qout;:&qout;mark&qout;,&qout;overlayTrigger&qout;:true}">
                <div data-reactroot="">
                  <div className="following-metadata">
                    <span className="following-count">
                      <span><span><b>{items.profile.user.following.length}</b> Following</span></span>
                    </span>
                    <span className="follower-count">
                      <span><span><b>{items.profile.user.followers.length}</b> Followers</span></span>
                    </span>
                  </div>
