...
module.exports = {
  addArticle: (req, res, next) => {
    ...
    if (req.files.images) {
      /**
       * Cloudinary is an Image/Video service which handles media (Images, Videos) sharing seamlessly. 
       * We will use it to upload our article feature image. They will host the images for us and use 
       * their image url to display our images on our frontend.
       */
